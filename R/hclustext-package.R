#' Optimized Hierarchical Clustering for Text Data
#'
#' Optimized tools for clustering text data via hierarchical clustering.
#' @docType package
#' @name hclustext
#' @aliases hclustext package-hclustext
NULL
