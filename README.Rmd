...
The distribution of turns of talk on clusters looked much better distributed.  I used `k = 60` for the number of topics.
...
The plots looked less messy and indeed topics do appear to be clustering around one another, though *time 1*'s talk is loading heavily onto a single cluster in comparison to the much more evenly distributed clusters in *time 2*.  I wanted to see how the primary participants, the candidates, compared to each other in topic use. 
