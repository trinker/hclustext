...
The user can grab the texts from the original documents grouped by cluster using the `get_text` function.  Here I do a 40 character substring of the document texts.
